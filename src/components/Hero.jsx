            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white min-h-screen">
                <div className="flex items-center justify-center flex-col space-y-5 p-25 animate-fadeInUp min-h-screen">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <Link
                            to="/packages"
                            className="group bg-[#C8A96A] text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-[#B89B5A] transition-all hover:scale-105 shadow-xl flex items-center space-x-2"
                        >
                        ...
                        <Link
                            to="/services"
                            className="bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-full text-lg font-medium border border-white/20 hover:bg-white/20 transition-all hover:scale-105"
                        >
                            View Services
                        </Link>
                    </div>
